...
public class ServerLoginPacketListenerImplMixin {
    ...
    private Cipher onKey$initializeVelocityCipher(int cip, Key var3) throws GeneralSecurityException {
        // Hijack this portion of the cipher initialization and set up our own encryption handler.
        ((ClientConnectionEncryptionExtension) this.connection).setupEncryption((SecretKey) var3);
