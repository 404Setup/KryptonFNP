...
public class ModMixinBootstrap implements IMixinConfigPlugin {
    ...
    enum CONFIG {
        ...
        BestVarLong("one.pkg.kfnp.mixin.network.microopt.FriendlyByteBufVarLongMixin", ModConfig.Mixin::isBestVarLong),
        BestVarInt("one.pkg.kfnp.mixin.network.microopt.FriendlyByteBufVarIntMixin", ModConfig.Mixin::isBestVarInt),
        BestUtf("one.pkg.kfnp.mixin.network.microopt.FriendlyByteBufUtfMixin", ModConfig.Mixin::isBestUtf),
        ;
